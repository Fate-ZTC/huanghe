var refresher = {
	...
	"pullingUpLable":"松开加载...",
	"pullingUpLoad":"正在加载...",
	"loadingLable":"<img src='/hik/tsp/page/img/loading.gif' alt=''>"},
	...
	for(var i=0;i<4;i++){
		...
		var content=document.createTextNode(refresher.info.pullingUpLoad);
		
		pullUpLabel.style.textAlign="center";
	...
	onScrolling:function(e,pullDownEl,pullUpEl,pullUpOffset){
		...
		pullDownEl.querySelector('.pullDownLabel').style.textAlign="center";
		...
		if (e.y > 0) {
			...
			if ( e.scrollerH < e.wrapperH && e.y < (e.minScrollY-pullUpOffset) || e.scrollerH > e.wrapperH && e.y< (e.maxScrollY - pullUpOffset) ) {
			 ...
			 if (e.scrollerH < e.wrapperH && e.y > (e.minScrollY-pullUpOffset) && pullUpEl.className.match('flip') || e.scrollerH > e.wrapperH && e.y > (e.maxScrollY - pullUpOffset) && pullUpEl.className.match('flip')) {
				...
				pullUpEl.querySelector('.pullUpLabel').style.textAlign="center";
			}
		},
...
onRelease:function (pullDownEl,pullUpEl){
	...
	onPulling:function (pullDownEl,pullDownAction,pullUpEl,pullUpAction){
		if (pullDownEl.className.match('flip')) {
				...
				pullDownEl.querySelector('.pullDownLabel').style.width="0.2rem";	
				pullDownEl.querySelector('.pullDownLabel').style.height="0.2rem";
				pullDownEl.querySelector('.pullDownLabel').style.margin="0 auto";			
			...
			if (pullUpEl.className.match('flip')) {
				...
				pullUpEl.querySelector('.pullUpLabel').style.margin="0 auto";
