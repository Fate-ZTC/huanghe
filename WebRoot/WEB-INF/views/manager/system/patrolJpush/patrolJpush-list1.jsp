...
<body>
    ...
    <div class="rightinfo">
    <form action="<%=path %>/patrolJpush_list" method="post" id="searchForm">
    <%--<ul class="seachform">--%>
	...
	<%--</ul>--%>
        ...
        <c:forEach items="${patrolUserPageBean.list}" var="d">
            <tr>
                <td><input type="checkbox" name="checkbox" value="${d.isJpush}" id="checkbox_${d.isJpush}" class="checkItem"/></td>
                <td>${d.username}</td>
                <td>${d.jobNum}</td>
            </tr>
        </c:forEach>
        <label>&nbsp;</label><input name="" type="submit" class="scbtn" value="提交"/>
