...
<body>
    ...
    <form action="<%=path %>/department_add" method="post" id="addForm" data-validator-option="{stopOnError:true, timely:1 ,theme:'yellow_right'}">
    <input type="hidden" name="method" value="add" />
    <ul class="forminfo">
    <li><label>名称<b>*</b></label><input name="name" type="text" class="dfinput" data-rule="名称:required;length[~100];"/></li>
    <li><label>描述</label><textarea name="description" cols="" rows="" class="textinput" style="width: 330px;height: 100px"></textarea></li>
