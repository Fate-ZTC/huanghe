...
<body>
    ...
    <ul class="placeul">
    <li><a href="#">月租管理</a></li>
    <li><a href="<%=path %>/monthlyHandle_list">月租续费</a></li>
    </ul>
    </div>
    ...
    <ul class="seachform">
		...
		<input type="hidden" name="isRenew" value="1"/>
...
<!--        </sec:authorize>-->
    ...
    <table class="tablelist">
        ...
        <tr>
        <!--<td><input type="checkbox" name="checkbox" value="${m.mid}" id="checkbox_${m.mid}" class="checkItem"/></td>-->
        <td>${m.carPlate}</td>
        ...
        <td><a href="<%=path %>/monthlyManage_detail?mid=${m.mid}&isRenew=1">详情</a></td>
        </tr> 
        </c:forEach>
        </tbody>
    </table>
